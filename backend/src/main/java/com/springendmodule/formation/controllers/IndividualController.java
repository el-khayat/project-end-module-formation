...
public class IndividualController {
	...
	public List<Formation> getIndividueFormations(@PathVariable Integer id) {
		IndividualDto individualDto = individualMapper.fromUser(service.getIndividualById(id));
		
		List<Formation> formations = individualDto.getFormations(); 
		return formations;
	}
	...
	public Individual getByNameAndEmail(@PathVariable String name, @PathVariable String email) {
		...
		List<Individual> individuals = service.getByNameAndEmail(name, email);
